...
def preProcessing(img):
    ...
    imgDilate = cv2.dilate(imgCanny, np.ones((5, 5)), iterations=2)
    imgThresh = cv2.erode(imgDilate, np.ones((5, 5)), iterations=1)
    return imgThresh
...
while True:
    ...
    cv2.imshow("work flow", stackedImage)
